...
export class LocationBuilder {
  ...
  constructor(gameContext: GameContext, savedLocation?: ILocation) {
    ...
    this._interactablesBuilder = new InteractablesBuilder(
      this._gameContext,
      this._savedLocation ? this._savedLocation.interactables : undefined
    );
    this._itemsBuilder = new ItemsBuilder(
      this._gameContext,
      this._savedLocation ? this._savedLocation.items : undefined
    );
    this._exitsBuilder = new ExitsBuilder(
      this._gameContext,
      this._savedLocation ? this._savedLocation.exits : undefined
    );
  }
  ...
  public configureInteractables(
    interactablesConfigurator: (interactablesBuilder: InteractablesBuilder) => void
  ): LocationBuilder {
