...
export class GameContext {
  ...
  public spawnExitInLocation(
    locationName: string,
    exitName: string,
    exitConfigurator: (exitBuilder: ExitBuilder) => void
  ): void {
  ...
  public spawnInteractableInLocation(
    locationName: string,
    interactableName: string,
    interactableConfigurator: (interactableBuilder: InteractableBuilder) => void
  ): void {
  ...
  public spawnItemInLocation(
    locationName: string,
    itemName: string,
    itemConfigurator: (itemBuilder: ItemBuilder) => void
  ): void {
